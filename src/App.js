  ...
  <div className="absolute right-0 top-full mt-2 bg-white rounded-lg shadow-lg border border-gray-200 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10 w-40">
    ...
    >
      ...
      Export TXT
              ...
              {/* NUEVO: Mostrar miniaturas de productos */}
              {project.items && project.items.length > 0 && (
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.items.slice(0, 6).map((item, idx) => {
...
const renderPacksList = (filteredPacks) => {
  ...
  // PRODUCT SELECTOR MODAL mejorado para Projects y Packs
      ...
      <div className="p-6 border-b border-slate-200">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-slate-800">
            {showPackForm ? 'Select Products for Pack' : 'Select Products for Project'}
          </h2>
          <button 
            onClick={() => {
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm text-slate-600">
            {showPackForm 
              ...
              : currentProject 
                ? `Project has: ${currentProject.items?.length || 0} items`
                : 'No active project'
            }
          </span>
          <button
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[100] p-4">
    <div className="bg-white rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
      ...
      <form onSubmit={handlePackSubmit} className="space-y-4">
        {/* SECCIÓN DE IMAGEN PARA PACK - NUEVA */}
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">
            Pack Image
          </label>
